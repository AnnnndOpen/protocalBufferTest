...
#ifndef PROTOBUF_INCLUDED_SearchRequest_2eproto
#define PROTOBUF_INCLUDED_SearchRequest_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_SearchRequest_2eproto 
...
namespace google {
namespace protobuf {
template<> ::tu::SearchRequest* Arena::CreateMaybeMessage<::tu::SearchRequest>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace tu {
...
class SearchRequest : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tu.SearchRequest) */ {
 public:
  SearchRequest();
  ...
  // @@protoc_insertion_point(class_scope:tu.SearchRequest)
 private:
  void set_has_query();
...
inline const ::std::string& SearchRequest::query() const {
  // @@protoc_insertion_point(field_get:tu.SearchRequest.query)
  return query_.GetNoArena();
}
inline void SearchRequest::set_query(const ::std::string& value) {
  set_has_query();
  query_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:tu.SearchRequest.query)
}
#if LANG_CXX11
inline void SearchRequest::set_query(::std::string&& value) {
  ...
  // @@protoc_insertion_point(field_set_rvalue:tu.SearchRequest.query)
}
#endif
inline void SearchRequest::set_query(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:tu.SearchRequest.query)
}
inline void SearchRequest::set_query(const char* value, size_t size) {
  set_has_query();
  query_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:tu.SearchRequest.query)
}
inline ::std::string* SearchRequest::mutable_query() {
  set_has_query();
  // @@protoc_insertion_point(field_mutable:tu.SearchRequest.query)
  return query_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline ::std::string* SearchRequest::release_query() {
  // @@protoc_insertion_point(field_release:tu.SearchRequest.query)
  if (!has_query()) {
    return NULL;
  }
  clear_has_query();
...
inline void SearchRequest::set_allocated_query(::std::string* query) {
  ...
  // @@protoc_insertion_point(field_set_allocated:tu.SearchRequest.query)
}
...
inline ::google::protobuf::int32 SearchRequest::page_number() const {
  // @@protoc_insertion_point(field_get:tu.SearchRequest.page_number)
  return page_number_;
}
inline void SearchRequest::set_page_number(::google::protobuf::int32 value) {
  set_has_page_number();
  page_number_ = value;
  // @@protoc_insertion_point(field_set:tu.SearchRequest.page_number)
}
...
inline ::google::protobuf::int32 SearchRequest::result_per_page() const {
  // @@protoc_insertion_point(field_get:tu.SearchRequest.result_per_page)
...
inline void SearchRequest::set_result_per_page(::google::protobuf::int32 value) {
  ...
  // @@protoc_insertion_point(field_set:tu.SearchRequest.result_per_page)
}
...
#endif  // PROTOBUF_INCLUDED_SearchRequest_2eproto
